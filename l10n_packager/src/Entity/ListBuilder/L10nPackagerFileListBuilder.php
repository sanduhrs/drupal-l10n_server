...
/**
 * Provides a list controller for the packager file entity type.
 */
class L10nPackagerFileListBuilder extends EntityListBuilder {
  ...
  public function render() {
    ...
    $build['summary']['#markup'] = $this->t('Total packager files: @total', ['@total' => $total]);
    return $build;
  }
